export default () => ({
  ...
  backup: {
    ...
    recipientEmail: process.env.BACKUP_EMAIL_TO || 'd9.fatm@gmail.com',
    artifactPrefix: process.env.BACKUP_ARTIFACT_PREFIX || 'vinaphone-backup',
    tempDirectory: process.env.BACKUP_TEMP_DIRECTORY || '',
  },
